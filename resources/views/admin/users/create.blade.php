        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{__('menu.Add Users')}}</li>
            </ol>
          </nav>
        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group-prepend">
                            <input type="number" class="form-control text-left" name="phone" id="phone" placeholder="Phone">
        ...
        $('#submitForm').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(data){
                    Swal.fire({
                        title: 'لقد تم حفظ المستخدم بنجاح !',
