        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{__('menu.Add Branch')}}</li>
            </ol>
          </nav>
        </div>
              ...
              <form id="submitForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="branch_name_ar" id="branch_name_ar" placeholder="Branch_Name(Arabic)">
                        <div class="invalid-feedback" style="display:contents;" id="branch_name_ar_error"></div>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>{{__('menu.Branch Name(English)')}}</label>
                        <input type="text" class="form-control" name="branch_name_en" id="branch_name_en" placeholder="Branch_Name(English)">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" name="branch_description_ar" id="branch_description_ar" rows="5" cols="30" placeholder="Branch Description(Arabic)" style="resize: none;"></textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" name="branch_description_en" id="branch_description_en" rows="5" cols="30" placeholder="Branch Description(English)" style="resize: none;"></textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        <label>{{__('menu.City')}}</label>
                            <div id="state-code">
                                <input type="text" class="form-control" name="city" id="state" placeholder="City">
                            </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control text-left" name="branch_location" id="branch_location" placeholder="Google Map Link">
                        <div class="invalid-feedback" style="display:contents;" id="branch_location_error"></div>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>{{__('menu.Working Hours From')}}</label>
                        <input type="time" class="form-control" name="working_hours_from" id="working_hours_from" placeholder="Working_Hours_From">
                        <div class="invalid-feedback" style="display:contents;" id="working_hours_from_error"></div>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>{{__('menu.Working Hours To')}}</label>
                        <input type="time" class="form-control" name="working_hours_to" id="working_hours_to" placeholder="Working_Hours_To">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="list-group list-group-horizontal">
                                    <li class="list-group-item text-center daysCSS1" data-value="1" style="border:1px solid #dad7d7;"><span class="spanCSS1">FRI</span></li>
                                    <li class="list-group-item text-center daysCSS2" data-value="2" style="border:1px solid #dad7d7;"><span class="spanCSS2">THU</span></li>
                                    <li class="list-group-item text-center daysCSS3" data-value="3" style="border:1px solid #dad7d7;"><span class="spanCSS3">WED</span></li>
                                    <li class="list-group-item text-center daysCSS4" data-value="4" style="border:1px solid #dad7d7;"><span class="spanCSS4">TUE</span></li>
                                    <li class="list-group-item text-center daysCSS5" data-value="5" style="border:1px solid #dad7d7;"><span class="spanCSS5">MON</span></li>
                                    <li class="list-group-item text-center daysCSS6" data-value="6" style="border:1px solid #dad7d7;"><span class="spanCSS6">SUN</span></li>
                                    <li class="list-group-item text-center daysCSS7" data-value="7" style="border:1px solid #dad7d7;"><span class="spanCSS7">SAT</span></li>
                                </ul>
                            </div>
                        </div>
                        <input type="hidden" name="working_days" id="working_days_array">
        ...
        $('#submitForm').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('#branch_name_ar').val('');
                    $('#branch_name_en').val('');
                    $('#branch_description_ar').val('');
                    $('#branch_description_en').val('');
                    $('#country').val('');
                    $('#state').val('');
                    $('#branch_location').val('');
                    $('#working_hours_from').val('');
                    $('#working_hours_to').val('');
                    $('#working_days_array').val('');
