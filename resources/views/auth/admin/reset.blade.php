...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="{{route('RESETWizard')}}" method="POST">
                @csrf
                ...
                <div class="wrap-input100 validate-input" data-validate = "Please enter email ex: admin@example.sa">
                    <input class="input100" type="email" name="email" placeholder="Your admin account Email" autocomplete="off">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Please strong password combined with numbers and characters">
                    <input class="input100" type="password" name="new_password" placeholder="NEW PASSWORD" autocomplete="off">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Please same password above">
                    <input class="input100" type="password" name="conf_password" placeholder="CONFIRM NEW PASSWORD" autocomplete="off">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
							<i class="fa fa-key" aria-hidden="true"></i>
						</span>
...
<span class="txt1">
                    ...
                    <a class="txt2" href="{{route('get.admin.login')}}">
                         Login?
                    </a>
...
<script>
    setTimeout(function(){ $(".alert-success").fadeOut(500).hide()} , 3000)
